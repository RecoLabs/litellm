...
ALTER TABLE "LiteLLM_ShadowEvalJob" ADD COLUMN     "released_at" TIMESTAMP(3);

UPDATE "LiteLLM_ShadowEvalJob" SET released_at = stopped_at WHERE stopped_at IS NOT NULL;
